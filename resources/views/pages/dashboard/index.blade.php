          ...
          <div class="mb-1">
            ...
            <div class="d-flex mt-3">
              ...
              <div class="flex-grow-1 ms-3">
                ...
                <p class="text-sm">Society has put up so many boundaries, so many limitations on what’s right and
                  wrong that it’s almost impossible to get a pure thought out. It’s like a little kid, a little boy.
                </p>
                <div class="d-flex">
                  <div>
                    <i class="ni ni-like-2 me-1 cursor-pointer opacity-6"></i>
          ...
          <div class="card bg-gradient-danger h-100">
            <div class="card-body">
              ...
              <div class="my-4">
                ...
                <div class="h6 text-white cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="bottom"
                  title="Copy Address">0yx8Wkasd8uWpa083Jj81qZhs923K21</div>
              </div>
              <div class="row mt-5">
                <div class="col">
                ...
                <div class="col ms-auto text-end">
                  <div class="btn-groups mt-3">
                    <div class="btn rounded-circle btn-sm btn-white mb-0 p-1" data-bs-toggle="tooltip"
                      data-bs-placement="top" title="Receive">
                      <i class="ni ni-bold-down p-2"></i>
                    </div>
                    <div class="btn rounded-circle btn-sm btn-white mb-0 p-1" data-bs-toggle="tooltip"
                      data-bs-placement="top" title="Send">
                      <i class="ni ni-bold-up p-2"></i>
                    </div>
                    <div class="btn rounded-circle btn-sm btn-white mb-0 p-1" data-bs-toggle="tooltip"
                      data-bs-placement="top" title="Swap">
                  ...
                  <div class="d-flex px-2 py-1">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                      ...
                      <p class="text-xs text-secondary mb-0"><a href="/cdn-cgi/l/email-protection"
                          class="__cf_email__"
                          data-cfemail="dfb5b0b7b19fbcadbabeabb6a9baf2abb6b2f1bcb0b2">[email&#160;protected]</a></p>
                    </div>
                  </div>
                </td>
                <td>
                ...
                <td>
                  <div class="d-flex px-2 py-1">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                      ...
                      <p class="text-xs text-secondary mb-0"><a href="/cdn-cgi/l/email-protection"
                          class="__cf_email__"
                          data-cfemail="57363b322f361734253236233e21327a233e3a7934383a">[email&#160;protected]</a>
                      </p>
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="d-flex px-2 py-1">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                      ...
                      <p class="text-xs text-secondary mb-0"><a href="/cdn-cgi/l/email-protection"
                          class="__cf_email__"
                          data-cfemail="335f524641565d477350415652475a45561e475a5e1d505c5e">[email&#160;protected]</a>
                      </p>
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="d-flex px-2 py-1">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                      ...
                      <p class="text-xs text-secondary mb-0"><a href="/cdn-cgi/l/email-protection"
                          class="__cf_email__"
                          data-cfemail="127f7b717a73777e5271607773667b64773f667b7f3c717d7f">[email&#160;protected]</a>
                      </p>
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="d-flex px-2 py-1">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                      ...
                      <p class="text-xs text-secondary mb-0"><a href="/cdn-cgi/l/email-protection"
                          class="__cf_email__"
                          data-cfemail="65170c060d0417012506170004110c130048110c084b060a08">[email&#160;protected]</a>
                      </p>
                    </div>
                  </div>
                </td>
